...
from english_us_text import (
    ...
    SPLIT_TRANSCRIPTION_TEXT,
    QUIT_TEXT,
    MAKE_A_PHONEME_UNVOICED_TEXT,
    VOICED_PHONEME_HEADER,
    UNVOICED_PHONEME_HEADER,
    PHONEME_DESCRIPTION_HEADER,
    PHONEMES_SPLIT_HEADER,
    FEATURES_HEADER,
    RESULT_HEADER,
...
class Application:
    ...
    def __init__(self, master=None):
        ...
        self.output_to_user_widget = Label(
            self.master,
        ...
        self.output_to_user_widget.grid(
            row=1,
            column=1,
            rowspan=5,
            sticky=N + S,
        ...
        self.output_description_label = Label(
            self.master, textvariable=self.output_description, width=100, justify=LEFT
        )
    ...
    def prompt_for_phoneme_to_calculate_sound_patterns_of_english_features_from(
        self,
    ) -> None:
        """
        Ask the user for a phoneme,
